"""Constants for the Natural Show integration."""
...
DOCS[CONF_ADAPT_UNTIL_SLEEP] = (
    "When enabled, Natural Show will treat sleep settings as the minimum, "
    "transitioning to these values after sunset. 🌙"
)

CONF_ADAPT_DELAY, DEFAULT_ADAPT_DELAY = "adapt_delay", 0
DOCS[CONF_ADAPT_DELAY] = (
    "Wait time (seconds) between light turn on and Natural Show applying "
