"""Documentation generation utilities for Natural Show.
...
def _transform_readme_links(content: str) -> str:
    ...
    link_map = {
        ...
        "#natural_showapply": "services.md#natural_showapply",
        "#natural_showset_manual_control": "services.md#natural_showset_manual_control",
        "#natural_showchange_switch_settings": "services.md#natural_showchange_switch_settings",
