...
from custom_components.natural_show import const

folder = Path("custom_components") / "natural_show"
...
# Set "services"
services_filename = Path("custom_components") / "natural_show" / "services.yaml"
