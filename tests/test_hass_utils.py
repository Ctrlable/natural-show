"""Tests for Natural Show HASS utils."""

from unittest.mock import AsyncMock

from homeassistant.components.natural_show.adaptation_utils import ServiceData
from homeassistant.components.natural_show.hass_utils import (
